...
public class ExerciseViewOrderFragment extends Fragment {
    ...
    public class ExerciseViewDragDropFragment extends Fragment implements View.OnDragListener, View.OnLongClickListener {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            contentHolder = view.findViewById(R.id.contentHolderOrder);
...
//        setContentLayout();
        ...
        private void setDynamicLayout() {
            ...
            for (int i = 0; i < contentArray.length; i++) {
                ...
                Log.i("M_EXERCISE_VIEW_ORDER","getContentArray, textParts: " + textParts.toString() + "contentLength: " + contentArray.length);
...
//
//                        Log.i("M_EXERCISE_VIEW_ORDER", " content: " + j + " " + textParts[j]);
//                        rowHolder.addView(textView1);
//                    } else {

//                    LinearLayout textHOlder = new LinearLayout(getContext());
//                    textHOlder.setLayoutParams(mParams);
//                    textHOlder.setOrientation(LinearLayout.VERTICAL);
//                    textHOlder.setTag("DROPVIEW" + j);
//                    dropTags.add("DROPVIEW" + j);
                    ...
                    textView1.setTextSize(TypedValue.COMPLEX_UNIT_SP, 20);
                    textView1.setTag("DRAGVIEW"+j);
                    dragTags.add("DRAGVIEW"+j);
                    Log.i("M_EXERCISE_VIEW_ORDER", " content: " + j + " " + textParts[j]);

//                    textHOlder.addView(textView1);
